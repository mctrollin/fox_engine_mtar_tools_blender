...
def draw_settings_page(layout, context) -> None:
    ...
    panel_shared.draw_bool_prop_checkbox_icon(col, settings_props, "show_advanced_settings")
    ...
    if settings_props.show_advanced_settings:
        ...
        panel_shared.draw_bool_prop_checkbox_icon(adv_box, settings_props, "show_pose_markers", text="Show Event Markers", toggle=True)

        # Rest Pose Correction toggle
        panel_shared.draw_bool_prop_checkbox_icon(adv_box, settings_props, "enable_rest_pose_correction", toggle=True)
        ...
        panel_shared.draw_bool_prop_checkbox_icon(adv_box, settings_props, "sort_gani", text="Sort GANI", toggle=True)
