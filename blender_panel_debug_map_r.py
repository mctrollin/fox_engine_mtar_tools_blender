...
class MTAR_PT_DebugMapRPanel(bpy.types.Panel):
    ...
    bl_label = "Map_R Debug"
    bl_idname = "MTAR_PT_debug_map_r"
    ...
    def draw(self, context):
        ...
        col.prop(scene.mtar_debug_map_r_props, "test_keyframe_w", text="W")
        col.prop(scene.mtar_debug_map_r_props, "test_keyframe_x", text="X")
        col.prop(scene.mtar_debug_map_r_props, "test_keyframe_y", text="Y")
        col.prop(scene.mtar_debug_map_r_props, "test_keyframe_z", text="Z")
        
        col.separator()
        col.label(text="As Euler angles (degrees):")
        row = col.row(align=True)
        row.enabled = False
        row.prop(scene.mtar_debug_map_r_props, "test_keyframe_euler_x", text="X")
        row.prop(scene.mtar_debug_map_r_props, "test_keyframe_euler_y", text="Y")
        row.prop(scene.mtar_debug_map_r_props, "test_keyframe_euler_z", text="Z")
        ...
        col = box.column(align=True)
        col.prop(scene.mtar_debug_map_r_props, "target_armature", text="Armature")
        col.prop(scene.mtar_debug_map_r_props, "target_bone", text="Bone")
        ...
        row = col.row(align=True)
        row.prop(scene.mtar_debug_map_r_props, "output_rest_pose_euler_x", text="X")
        row.prop(scene.mtar_debug_map_r_props, "output_rest_pose_euler_y", text="Y")
        row.prop(scene.mtar_debug_map_r_props, "output_rest_pose_euler_z", text="Z")
        row.operator("mtar.copy_rest_pose_euler", text="", icon='COPYDOWN')
        
        col.separator()
        col.label(text="Rest Pose Rotation (Quaternion):")
        row = col.row(align=True)
        row.prop(scene.mtar_debug_map_r_props, "output_rest_pose_quat_w", text="W")
        row.prop(scene.mtar_debug_map_r_props, "output_rest_pose_quat_x", text="X")
        row.prop(scene.mtar_debug_map_r_props, "output_rest_pose_quat_y", text="Y")
        row.prop(scene.mtar_debug_map_r_props, "output_rest_pose_quat_z", text="Z")
        row.operator("mtar.copy_rest_pose_quat", text="", icon='COPYDOWN')
        
        col.separator()
        col.label(text="Calculated Map_R Parameter:")
        row = col.row(align=True)
        row.prop(scene.mtar_debug_map_r_props, "output_map_r", text="")
        row.operator("mtar.copy_map_r_to_clipboard", text="", icon='COPYDOWN')
        
        col.separator()
        col.label(text="Mapped Animation Keyframe (after map_r):")
        row = col.row(align=True)
        row.prop(scene.mtar_debug_map_r_props, "output_mapped_quat_w", text="W")
        row.prop(scene.mtar_debug_map_r_props, "output_mapped_quat_x", text="X")
        row.prop(scene.mtar_debug_map_r_props, "output_mapped_quat_y", text="Y")
        row.prop(scene.mtar_debug_map_r_props, "output_mapped_quat_z", text="Z")
        ...
        row = col.row(align=True)
        row.enabled = False
        row.prop(scene.mtar_debug_map_r_props, "output_mapped_euler_x", text="X")
        row.prop(scene.mtar_debug_map_r_props, "output_mapped_euler_y", text="Y")
        row.prop(scene.mtar_debug_map_r_props, "output_mapped_euler_z", text="Z")
        
        col.separator()
        col.label(text="Debug Info:")
        col.prop(scene.mtar_debug_map_r_props, "debug_log", text="")
...
class MTAR_OT_DebugAnalyzeMapR(bpy.types.Operator):
    ...
    def execute(self, context):
        scene = context.scene
        props = scene.mtar_debug_map_r_props
...
class MTAR_OT_CopyMapRToClipboard(bpy.types.Operator):
    ...
    def execute(self, context):
        scene = context.scene
        map_r_value = scene.mtar_debug_map_r_props.output_map_r
...
class MTAR_OT_CopyRestPoseEuler(bpy.types.Operator):
    ...
    def execute(self, context):
        props = context.scene.mtar_debug_map_r_props
...
class MTAR_DebugMapRProperties(bpy.types.PropertyGroup):
...
# Note: This module is registered/unregistered by blender_panel_debug.py as part of debug tools
